...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "4f89edd8334da198099c686b993ec9f9f12dccdf"
  WORKING_DIRECTORY "D:/VSProjects/SphericalRidgelets/out/build/x64-Debug (default)/itk/ITK"
...
if("${show_ref_output}" MATCHES "refs/remotes/4f89edd8334da198099c686b993ec9f9f12dccdf")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "4f89edd8334da198099c686b993ec9f9f12dccdf")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "4f89edd8334da198099c686b993ec9f9f12dccdf")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'git://github.com/Slicer/ITK.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'D:/VSProjects/SphericalRidgelets/out/build/x64-Debug (default)/itk/ITK'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/VSProjects/SphericalRidgelets/out/build/x64-Debug (default)/itk/ITK'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
