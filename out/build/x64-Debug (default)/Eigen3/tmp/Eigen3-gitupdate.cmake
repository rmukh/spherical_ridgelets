...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "3.3.7"
  WORKING_DIRECTORY "D:/VSProjects/SphericalRidgelets/out/build/x64-Debug (default)/Eigen3/src/Eigen3"
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'git://github.com/eigenteam/eigen-git-mirror'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'D:/VSProjects/SphericalRidgelets/out/build/x64-Debug (default)/Eigen3/src/Eigen3'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/VSProjects/SphericalRidgelets/out/build/x64-Debug (default)/Eigen3/src/Eigen3'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
